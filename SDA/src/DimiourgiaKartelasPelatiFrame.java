...
public class DimiourgiaKartelasPelatiFrame extends JFrame{
	...
	public DimiourgiaKartelasPelatiFrame(DataBase db){
		super("Dimiourgia Kartelas Pelati");
		setIconImage(Toolkit.getDefaultToolkit().getImage(DimiourgiaKartelasPelatiFrame.class.getResource("/Icons/Chrome.png")));
		...
		epwnymiaL.setIcon(new ImageIcon(DimiourgiaKartelasPelatiFrame.class.getResource("/Icons/hire-me.png")));
		this.epwnymiaF = new JTextField(20);
		this.afmL = new JLabel("Afm: ");
		afmL.setIcon(new ImageIcon(DimiourgiaKartelasPelatiFrame.class.getResource("/Icons/consulting.png")));
		this.afmF = new JTextField(20);
		this.addressL = new JLabel("Dieythinsi: ");
		addressL.setIcon(new ImageIcon(DimiourgiaKartelasPelatiFrame.class.getResource("/Icons/address.png")));
		this.addressF = new JTextField(20);
		this.zipCodeL = new JLabel("T.K.: ");
		zipCodeL.setIcon(new ImageIcon(DimiourgiaKartelasPelatiFrame.class.getResource("/Icons/world.png")));
		this.zipCodeF = new JTextField(20);
		this.phoneL = new JLabel("Thl.: ");
		phoneL.setIcon(new ImageIcon(DimiourgiaKartelasPelatiFrame.class.getResource("/Icons/contact.png")));
		this.phoneF = new JTextField(20);
		this.bankIbanL = new JLabel("IBAN: ");
		bankIbanL.setIcon(new ImageIcon(DimiourgiaKartelasPelatiFrame.class.getResource("/Icons/bank.png")));
		...
		kataxB.setBounds(171, 150, 120, 25);
		masterPanel.add(kataxB);
		kataxB.setIcon(new ImageIcon(DimiourgiaKartelasPelatiFrame.class.getResource("/Icons/check.png")));
		this.kataxB.addActionListener(new ButtonListener());
		this.getRootPane().setDefaultButton(kataxB);

		this.setContentPane(masterPanel);

		this.setSize(500,234);
	...
	class ButtonListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			Pelatis tempPel = new Pelatis(epwnymiaF.getText(), afmF.getText(), addressF.getText(), zipCodeF.getText(), phoneF.getText(), bankIbanF.getText());
			...
			if(epwnymiaF.getText().equals("")  || afmF.getText().equals("") || addressF.getText().equals("") || zipCodeF.getText().equals("")|| phoneF.getText().equals("")|| bankIbanF.getText().equals("")){
				JOptionPane.showMessageDialog(masterPanel, "Den egine kataxwrisi pelati  , simplirose ola ta pedia","ERROR",JOptionPane.ERROR_MESSAGE);
				found=true;
			}
			 ...
			 */
				...
				db.addPelatis(tempPel);
				db.serializing();

				JOptionPane.showMessageDialog(masterPanel, "Epitixis kataxwrisi pelati","Epityxia",JOptionPane.INFORMATION_MESSAGE);
				clearFields();
			}
		}
	}
