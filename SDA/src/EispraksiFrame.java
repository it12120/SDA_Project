...
public class EispraksiFrame extends JFrame {
...
/*	public static void main(String[] args) {
	 ...
	 * Create the frame.
	 */
	public EispraksiFrame(DataBase db) {
...
/*		DefaultListModel listModel = new DefaultListModel();
		...
		lblPoso.setIcon(new ImageIcon(EispraksiFrame.class.getResource("/Icons/issue.png")));
		lblPoso.setBounds(10, 171, 69, 14);
		...
		btnOk.addActionListener(new ButtonListener1());
		...
		public void actionPerformed(ActionEvent e) {
			...
			for(Pelatis p : db.getPelatesList()){
				if(p.getEpwnymia() == selectedPelatisText){
					...
					JOptionPane.showMessageDialog(masterPanel, "Epitixis Kataxwrisi Eispraksis");
					textField.setText("");
					db.serializing();
				}
			}
